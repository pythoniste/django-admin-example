...
CreationMonthListFilter = month_list_filter_factory(
    "creation_date", _("creation date"), "creation_date", "month")
ModificationMonthListFilter = month_list_filter_factory(
    "last_modification_date", _("last modification date"), "last_modification_date", "month")
RandomMonthListFilter = month_list_filter_factory(
    "random_date", _("random date"), "random_date", "month")
